...
in
{
  programs.claude-code = {
    ...
    settings = {
      ...
      statusLine = {
        type = "command";
        command = "node ${config.home.homeDirectory}/.claude/hud/omc-hud.mjs";
      };
      enabledPlugins = {
      ...
      # GitHub-hosted marketplaces (not local directories, so use settings directly)
